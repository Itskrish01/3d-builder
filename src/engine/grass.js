...
import { BALL_FS, BALL_VS, GRASS_FS, GRASS_VS, GROUND_FS, GROUND_VS, RING_FS, RING_VS, SKY_FS, SKY_VS } from './shaders.js';
import { DENS_N, MAX_BLADES, state } from './state.js';
import { Terrain, buildGroundGeometry, computeTerrainHeights, heightAt, normalAt } from './terrain.js';
import { clamp } from './util.js';

/* The three scene objects createScene() builds, kept beside it rather than
   with the terrain they used to be declared next to. */
export var sky = null, ball = null, ring = null;

/* ==========================================================================
   7. GRASS SYSTEM
   ========================================================================== */

export var BLADE_ATTRS = [['aOffset', 3], ['aNormal', 3], ['aRot', 1], ['aSize', 2], ['aShape', 2], ['aSeed', 1]];
export var BLADE_STRIDE = 12;   // floats per blade across all attributes
...
export function bladeTemplate(S) {
...
export function rebuildBladeTemplate() {
  var tpl = bladeTemplate(state.grass.segments);
  var g = Grass.geo;
...
export function markDirty(from, to) {
...
/* ---- blade read / write -------------------------------------------------- */
export function writeBlade(i, x, y, z, nx, ny, nz, rot, hm, wm, bend, stiff, seed) {
  var A = Grass.arr;
  var o3 = i * 3, o2 = i * 2;
...
export function readBlade(i, out) {
...
export var _snapN = new THREE.Vector3();
export function resnapAll() {
...
export function resnapRegion(cx, cz, r) {
