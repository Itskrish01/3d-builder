...
import { syncObjectEnv } from './assets.js';
import { Grass, ball, ring, sky } from './grass.js';
import { Env, renderer, updateEnv } from './renderer.js';
import { FIELD_N, state } from './state.js';
import { Terrain, heightAt } from './terrain.js';
import { DEG, TAU, clamp, hexLin, smoothstep } from './util.js';
import { syncWaterUniforms } from './water.js';
...
export function pushInfluence(x, z, radius, strength, vx, vz) {
...
/* ==========================================================================
   ...
   ========================================================================== */
export var _v3a = new THREE.Vector3(), _v3b = new THREE.Vector3();

export function updateGrassBounds() {
...
export function syncGrassUniforms() {
...
export function syncGroundUniforms() {
...
export function syncEnvUniforms() {
  updateEnv();
  var e = state.env;
...
/* ==========================================================================
   ...
   ========================================================================== */
export function updateRing(cx, cz, radius, visible) {
